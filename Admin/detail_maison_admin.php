...
$chambre = addslashes($_POST['nbreChambre']);
$salon = addslashes($_POST['nbreSalon']);
$interne = addslashes($_POST['nbreDoucheInterne']);
$externe = addslashes($_POST['nbreDoucheExterne']);
$nbre_lit = addslashes($_POST['nbre_lit']);
$ville = addslashes($_POST['ville']);
$prix = addslashes($_POST['prix']);
$garage = addslashes($_POST['garage']);
$dispo = addslashes($_POST['disponibilite']);

//$pay = $_POST['paye'];


  $sql11 ="UPDATE maison SET description='$des',statut='$statut',type_bien='$type_bien',dimension='$dimension',quartier='$quartier',nbre_chambre='$chambre',nbre_salon='$salon',douche_interne='$interne',douche_externe='$externe',nbre_lit='$nbre_lit',ville='$ville',prix='$prix',garage='$garage',disponibilite='$dispo' where id_maison='$id'";
  ...
  if($requete11){
    ...
    ?>
      ...
      document.location.href="detail_maison_admin.php?id="<?php echo $id;  ?>
      </script>
    <?php
...
else
{
  //Code JavaScript
    ?>
      ...
      document.location.href="detail_maison_admin.php"
      </script>
    <?php
    //fin du code javascript
}
...
$id=$_POST ["idm"] ;
$dispo1 = addslashes($_POST['disponibilite']);

//$pay = $_POST['paye'];


  $sql11 ="UPDATE maison SET disponibilite='$dispo1' where id_maison='$id'";
  ...
  if($requete11){
    ...
    ?>
      <script language="javascript">
      window.alert("Archivée avec succès !")
      document.location.href="gestion_maison.php?id="<?php echo $id;  ?>
      </script>
    <?php
    //fin du code javascript
  }
...
<body>
  <section id="container">
   ...
   <?php
    ...
    $id1 = $_GET["id_maison"] ;
    $sql = "SELECT * FROM maison WHERE id_maison = ".$id1 ;
   ...
   <section class="wrapper">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single"><?php echo $row['type_bien']; ?> <?php echo $row['statut']; ?></h1>
              <span class="color-text-a"><?php echo $row['ville']; ?>, <?php echo $row['quartier']; ?></span>
            </div>
          </div>
          <div class="col-md-12 col-lg-4">
            <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <a href="gestion_maison.php">Les maisons</a>
                </li>
              </ol>
            </nav>
          </div>
    ...
    <!-- ======= Property Single ======= -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
             <div class="photo">
              <img src="<?php echo "../images/image_maison/".$row['img1']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid">
              </div>
          </div>
        
          <div class="col-md-6">
             <div class="photo">
              <img src="<?php echo "../images/image_maison/".$row['img2']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid" >
                </div>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-md-6">
             <div class="photo">
              <img src="<?php echo "../images/image_maison/".$row['img3']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid" >
                </div>
          </div>
          
          <div class="col-md-6">
             <div class="photo">
              <img src="<?php echo "../images/image_maison/".$row['img4']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid" >
                </div>
          </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="property-price d-flex justify-content-center foo">
                  <div class="card-header-c d-flex">
                    <div class="card-box-ico">
                       <b><?php echo $row['type_bien']; ?> <?php echo $row['statut']; ?> </b>
                  ...
                  <div class="summary-list">
                    <ul class="list">
                      ...
                      <li class="d-flex justify-content-between">
                        ...
                        <span><b><?php echo $row['type_bien']; ?></b></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Statut de la maison :</strong>
                      ...
                      <li class="d-flex justify-content-between">
                        <strong>Ville :</strong>
                        <span><b><?php echo $row['ville']; ?></b></span>
                      </li>
                      <li class="d-flex justify-content-between">
              ...
              <div class="col-md-7 col-lg-7 section-md-t3">
                ...
                <div class="amenities-list color-text-a">
                  <ul class="list-a no-margin">
                    ...
                    <li>Douche externe : 
                      <span><b><?php echo $row['douche_externe']; ?></b></span>
                    </li>
                    <li>Nombre de lit  : 
                      <span><b><?php echo $row['nbre_lit']; ?></b></span>
                    </li>
                    <li>Garage ? : 
          ...
          <a data-toggle="modal" href="#myModal1" class="btn btn-success">Archiver</a>
    ...
    <!--modele de modification-->
     ...
     <?php
        //include('../connexion.php');
        $id1=$_GET['id_maison'];       
        $sql1 = "SELECT * FROM maison WHERE id_maison= ".$id1;
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title centered">Modification des informations sur une maison</h4>
              </div>
              <div class="modal-body">
                <div class="login-wrap">
                  <div class="row">
                   <div class="col-md-6">
                     <input type="text" hidden name="idm" value="<?php echo $res1['id_maison']; ?>">
                    ...
                    <label>Statut</label>
                      ...
                      <select class="form-control form-select form-control-a" name="type_bien">
                        <option><?php echo $res1["type_bien"]; ?></option>
                    ...
                    <label>Quartier</label>
                      <input type="text" class="form-control" name="quartier" value=" <?php echo $res1["quartier"]; ?>">

                    <label>Nombre de chambre</label>
                      <input type="text" class="form-control" name="nbreChambre" value=" <?php echo $res1["nbre_chambre"]; ?>">
                    
                    <label>Nombre de salon</label>
                      <input type="text" class="form-control" name="nbreSalon" value=" <?php echo $res1["nbre_salon"]; ?>">
                    
                    <label>Nombre douche interne</label>
                      <input type="text" class="form-control" name="nbreDoucheInterne" value=" <?php echo $res1["douche_interne"]; ?>">

                    <label>Nombre douche externe</label>
                     <input type="text" class="form-control" name="nbreDoucheExterne" value=" <?php echo $res1["douche_externe"]; ?>">
                    <br>
                  </div>
                    
                  <div class="col-md-6">
                    <label>Nombre de lit</label>
                      <input type="text" class="form-control" name="nbre_lit" value=" <?php echo $res1["nbre_lit"]; ?>">

                    <label>Ville</label>
                      <input type="text" class="form-control" name="ville" value=" <?php echo $res1["ville"]; ?>">
                    ...
                    <label>Y'a-t-il un garage ?</label>
                      <select class="form-control form-select form-control-a" name="garage">
                        <option><?php echo $res1["garage"]; ?></option>
                        <option>Oui</option>
                        <option>Non</option> 
                      </select>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal1" class="modal fade">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title centered">Archiver une maison</h4>
              </div>
              <div class="modal-body">
                <div class="login-wrap">
                ...
                <div class="modal-footer centered">
                  <button class="btn btn-theme" name="archive" type="submit"><i class=""></i> Archiver</button> 
                </div>        
              </div>
            </div>
          </div>
