        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                <div id="GFG" style="">
                  <h2 align = 'center' style="margin-bottom:20px;">LISTE DES MAISONS ARCHIVEES</h2>
                  <div>
                    ...
                    <div>
                      <div class="row">
                        ...
                        <tbody id="tbl_body">
                          <?php
                           include("../connexion.php");
                            $sql = "select * from maison where disponibilite='Occupée' order by id_maison desc limit 100 ";
