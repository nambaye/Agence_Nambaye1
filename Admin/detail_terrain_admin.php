...
$titre_foncier = addslashes($_POST['titre_foncier']);


//$pay = $_POST['paye'];


  $sql11 ="UPDATE terrain SET description='$des',statut='$statut',dimension='$dimension',quartier='$quartier',ville='$ville',nbre_lot='$nbre_lot',disponibilite='$disponibilite',prix='$prix',titre_foncier='$titre_foncier' where id_terrain='$id'";
...
<body>
  <section id="container">
   ...
   <?php
    ...
    $id1 = $_GET["id_terrain"] ;
    $sql = "SELECT * FROM terrain WHERE id_terrain = ".$id1 ;
   ...
   <section class="wrapper">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Maison <?php echo $row['statut']; ?></h1>
          ...
          <div class="col-md-12 col-lg-4">
            <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <a href="property-grid.php">Les terrains</a>
                </li>
              </ol>
            </nav>
          </div>
    ...
    <!-- ======= Property Single ======= -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
             <div class="">
              <img src="<?php echo "../images/image_terrain/".$row['img1']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid">
                </div>
          </div>
        
          <div class="col-md-6">
             <div class="">
              <img src="<?php echo "../images/image_terrain/".$row['img2']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid" >
                </div>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-md-6">
             <div class="">
              <img src="<?php echo "../images/image_terrain/".$row['img3']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid" >
                </div>
          </div>
          
          <div class="col-md-6">
             <div class="">
              <img src="<?php echo "../images/image_terrain/".$row['img4']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid" >
                </div>
          </div>
        </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="property-price d-flex justify-content-center foo">
                  <div class="card-header-c d-flex">
                    <div class="card-box-ico">
                       <b>Terrain <?php echo $row['statut']; ?> </b>
                  ...
                  <div class="summary-list">
                    <ul class="list">
                      <li class="d-flex justify-content-between">
                        <strong>Dimension du terrain :</strong>
                      ...
                      <li class="d-flex justify-content-between">
                        <strong>Nombre lot :</strong>
                        <span><b><?php echo $row['nbre_lot']; ?></b></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Prix :</strong>
                        <span><b><?php echo $row['prix']; ?></b></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Ville :</strong>
              ...
              <div class="col-md-7 col-lg-7 section-md-t3">
                ...
                <div class="amenities-list color-text-a">
                  <ul class="list">
                    <li>Le terrain possède t-il un titre fincier ? 
                      <span><b><?php echo $row['titre_foncier']; ?></b></span>
                    </li>
                  </ul>
                </div>
              </div>
    ...
    <!--modele de modification-->
     ...
     <?php
        //include('../connexion.php');
        $id1=$_GET['id_terrain'];       
        $sql1 = "SELECT * FROM terrain WHERE id_terrain= ".$id1;
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title centered">Modification des informations sur un terrain</h4>
              </div>
              <div class="modal-body">
                <div class="login-wrap">
                  <div class="row">
                   <div class="col-md-6">
                     <input type="text" hidden name="idt" value="<?php echo $res1['id_terrain']; ?>">
                    ...
                    <label>Nombre du lot du terrain</label>
                      <input type="text" class="form-control" name="nbre_lot" value=" <?php echo $res1["nbre_lot"]; ?>">
                  ...
                  <div class="col-md-6">
                    ...
                    <label>Y'a t-il un titre fonçier ?</label>
                      <select class="form-control form-select form-control-a" name="titre_foncier">
                        <option><?php echo $res1["titre_foncier"]; ?></option>
                        <option>Oui</option> 
                        <option>Non</option> 
                      </select>
