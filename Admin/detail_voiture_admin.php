...
//$pay = $_POST['paye'];
  ...
  $sql11 ="UPDATE voiture SET description='$des',statut='$statut',model='$model',marque='$marque',transmission='$transmission',reservoir='$reservoir',capacite_moteur='$capacite_moteur',nbre_place='$nbre_place',nbre_pneus='$nbre_pneus',taille_boite='$taille_boite',disponibilite='$disponibilite',prix='$prix' where id_voiture='$id'";
  ...
  if($requete11){
    ...
    ?>
      ...
      document.location.href="detail_voiture_admin.php?id="<?php echo $id;  ?>
      </script>
    <?php
...
else
{
  //Code JavaScript
    ?>
      ...
      document.location.href="detail_voiture_admin.php"
      </script>
    <?php
    //fin du code javascript
}
...
<body>
  <section id="container">
   ...
   <?php
    ...
    $id1 = $_GET["id_voiture"] ;
    $sql = "SELECT * FROM voiture WHERE id_voiture = ".$id1 ;
   ...
   <section class="wrapper">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Voiture <?php echo $row['statut']; ?></h1>
              <span class="color-text-a"><?php echo $row['model']; ?>, <?php echo $row['marque']; ?></span>
            </div>
          </div>
          <div class="col-md-12 col-lg-4">
            <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <a href="property-grid.php">Les voitures</a>
                </li>
              </ol>
            </nav>
          </div>
    ...
    <!-- ======= Property Single ======= -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
             <div class="">
              <img src="<?php echo "../images/image_voiture/".$row['img1']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid">
                </div>
          </div>
        
          <div class="col-md-6">
             <div class="">
              <img src="<?php echo "../images/image_voiture/".$row['img2']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid" >
                </div>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-md-6">
             <div class="">
              <img src="<?php echo "../images/image_voiture/".$row['img3']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid" >
                </div>
          </div>
          
          <div class="col-md-6">
             <div class="">
              <img src="<?php echo "../images/image_voiture/".$row['img4']; ?>" width="100%" height="100%" alt="" class="img-d img-fluid" >
                </div>
          </div>
        </div>
            ...
            <div class="row justify-content-between">
                  ...
                  <div class="summary-list">
                    <ul class="list">
                      ...
                      <li class="d-flex justify-content-between">
                        ...
                        <span><b><?php echo $row['marque']; ?></b></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Modèle :</strong>
                        <span><b><?php echo $row['model']; ?></b></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Transmission :</strong>
                        <span><b><?php echo $row['transmission']; ?></b></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Capacité réservoir :</strong>
                        <span><b><?php echo $row['reservoir']; echo " litre";?></b></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Capacité moteur :</strong>
                        <span><b><?php echo $row['capacite_moteur']; ?></b></span>
                      </li>
                      <li class="d-flex justify-content-between">
              ...
              <div class="col-md-7 col-lg-7 section-md-t3">
                ...
                <div class="amenities-list color-text-a">
                  <ul class="list">
                    <li>Nombre place :
                      <span><b><?php echo $row['nbre_place']; ?></b></span>
                    </li>
                    <li>Nombre pneus :
                      <span><b><?php echo $row['nbre_pneus']; ?></b></span>
                    </li>
                    <li>Taille de la boite :
                      <span><b><?php echo $row['taille_boite']; ?></b></span>
                    </li>
                  </ul>
                </div>
              </div>
    ...
    <!--modele de modification-->
     ...
     <?php
        //include('../connexion.php');
        $id1=$_GET['id_voiture'];       
        $sql1 = "SELECT * FROM voiture WHERE id_voiture= ".$id1;
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title centered">Modification des informations sur une voiture</h4>
              </div>
              <div class="modal-body">
                <div class="login-wrap">
                  <div class="row">
                   <div class="col-md-6">
                     <input type="text" hidden name="idv" value="<?php echo $res1['id_voiture']; ?>">
                    ...
                    <label>Modèle de la voiture</label>
                      <input type="text" class="form-control" name="model" value=" <?php echo $res1["model"]; ?>">

                    <label>Marque de la voiture</label>
                      <input type="text" class="form-control" name="marque" value=" <?php echo $res1["marque"]; ?>">

                    <label>Transmission</label>
                      <input type="text" class="form-control" name="transmission" value=" <?php echo $res1["transmission"]; ?>">
                    
                    <label>Capacité reservoir (en L)</label>
                      <input type="text" class="form-control" name="reservoir" value=" <?php echo $res1["reservoir"]; ?>">

                    <label>Capacité moteur</label>
                      <input type="text" class="form-control" name="capacite_moteur" value=" <?php echo $res1["capacite_moteur"]; ?>">

                    <label>Nombre de place</label>
                      <input type="number" min=2 class="form-control" name="nbre_place" value=" <?php echo $res1["nbre_place"]; ?>">
                  ...
                  <div class="col-md-6">
                    ...
                    <label>Nombre de pneus</label>
                      <input type="text" class="form-control" name="nbre_pneus" value=" <?php echo $res1["nbre_pneus"]; ?>">

                      <label>Taille de la boite</label>
                      <input type="text" class="form-control" name="taille_boite" value=" <?php echo $res1["taille_boite"]; ?>">
