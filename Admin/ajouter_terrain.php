...
if (isset($_REQUEST['ajouter'])) {
  if(empty($_POST['description']) OR empty($_POST['statut']) OR empty($_POST['dimension']) OR empty($_POST['quartier']) OR empty($_POST['ville']) OR empty($_POST['nbre_lot']) OR empty($_POST['prix_terrain']) OR empty($_POST['titre_foncier']) OR empty($_POST['disponibilite'])){

      //Code JavaScript
        ?>
        <script language="javascript">
            window.alert('Tous les champs doivent être completés !')
            document.location.href="ajouter_terrain.php"
        </script>
        <?php
        exit();
      ...
      $sql = "INSERT INTO `terrain` (`description`, `statut`, `dimension`, `quartier`, `ville`, `nbre_lot`, `disponibilite`, `prix`, `img1`, `img2`, `img3`, `img4`) VALUES ('$des', '$statut', '$dimension', '$quartier', '$ville', '$nbre_lot','$disponilite', '$prix','$titre_foncier', '$imge1', '$imge2', '$imge3', '$imge4') " ;
  ...
  <section id="container">
    ...
    <!-- **********************************************************************************************************************************************************
      ...
      <form class="form-login1" action="" method="POST" enctype="multipart/form-data">
        <h2 class="form-login-heading1">Ajouter un terrain !</h2>

        <div class="login-wrap">
        <div class="row">
         <div class="col-md-6">
          <label>Description du terrain</label>
          <textarea type="text" class="form-control" placeholder="La description du terrain..." autofocus name="description"></textarea>
        ...
        <div class="col-md-6">
          ...
          <select class="form-control form-select form-control-a" name="disponibilite">
            <option>* Selectionner la réponse *</option>
            <option value="Libre">Oui</option>
            <option value="Occupée">Non</option> 
          </select>
