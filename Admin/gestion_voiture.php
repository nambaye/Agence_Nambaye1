        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                <div id="GFG" style="">
                  <h2 align = 'center' style="margin-bottom:20px;">LISTE DES VOITURES</h2>
                  <div>
                    ...
                    <div>
                      <div class="row">
                        ...
                        <div class="panel-heading">
                          <h3 class="panel-title">Table voitures
                        <span class="btn btn-success btn-xs">
                            <a href="ajouter_voiture.php" style="color: white;">Ajouter voiture<i class="glyphicon glyphicon-plus" style="width: 30px; height: 20px; left: center;"></i></a>
                          </span>
                          </h3>
                        </div><br>
                        ...
                        <thead>
                          <tr>
                            ...
                            <th><i class=" "></i> Transmission</th>
                            <th><i class=" "></i> Réservoir</th>
                            <th><i class=" "></i> Capacité moteur</th>
                        ...
                        <tbody id="tbl_body">
                          <?php
                           include("../connexion.php");
                            $sql = "select * from voiture order by id_voiture desc limit 20";
                          ...
                          <tr>               
                            ...
                            <td>
                              <input type="hidden" value="<?php echo $res['model'];?>" name="MODEL[]"/><?php echo $res['model']; ?></td>
                            <td>
                              <input type="hidden" value="<?php echo $res['marque'];?>" name="MARQUE[]"/><?php echo $res['marque']; ?>
                            </td>
                            <td>
                              <input type="hidden" value="<?php echo $res['transmission'];?>" name="TRANS[]"/><?php echo $res['transmission']; ?>
                            </td>
                            <td>
                              <input type="hidden" value="<?php echo $res['reservoir'];?>" name="RES[]"/><?php echo $res['reservoir']; ?>
                            </td>
                            <td>
                              <input type="hidden" value="<?php echo $res['capacite_moteur'];?>" name="CAP[]"/><?php echo $res['capacite_moteur']; ?>
                            </td>
                            <td>
                            ...
                            <td>
                              ...
                              <a data-toggle="modal" href="detail_voiture_admin.php?id_voiture=<?php echo $res['id_voiture']; ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                              <a  data-toggle="modal" href="sup_voiture.php?id_voiture=<?php echo $res['id_voiture']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
                            </td>
                          </tr>
