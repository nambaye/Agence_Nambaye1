        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                <div id="GFG" style="">
                  <h2 align = 'center' style="margin-bottom:20px;">LISTE DES MEUBLES</h2>
                  <div>
                    ...
                    <div>
                      <div class="row">
                        ...
                        <div class="panel-heading">
                          <h3 class="panel-title">Table meubes
                        <span class="btn btn-success btn-xs">
                            <a href="ajouter_meuble.php" style="color: white;">Ajouter meuble<i class="glyphicon glyphicon-plus" style="width: 30px; height: 20px; left: center;"></i></a>
                          </span>
                          </h3>
                        </div><br>
                        ...
                        <thead>
                          <tr>
                            ...
                            <th><i class=""></i> Type meuble</th>
                            <th><i class=" "></i> Capacité</th>
                        ...
                        <tbody id="tbl_body">
                          <?php
                           include("../connexion.php");
                            $sql = "select * from meuble order by id_meuble desc limit 20";
                          ...
                          <tr>               
                            ...
                            <td>
                              <input type="hidden" value="<?php echo $res['type_meuble'];?>" name="TYPE[]"/><?php echo $res['type_meuble']; ?></td>
                            <td>
                              <input type="hidden" value="<?php echo $res['capacite'];?>" name="CAPACITE[]"/><?php echo $res['capacite']; ?>
                            </td>
                            <td>
                            ...
                            <td>
                              ...
                              <a data-toggle="modal" href="detail_meuble_admin.php?id_meuble=<?php echo $res['id_meuble']; ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                              <a  data-toggle="modal" href="sup_meuble.php?id_meuble=<?php echo $res['id_meuble']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
                            </td>
                          </tr>
