        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Terrain <?php echo $row['statut']; ?></h1>
            ...
            <div class="row">
              <div class="col-md-6 col-lg-4">
               ...
               <hr>
                ...
                <a href="https://wa.me/+23672281873? text= ID Terrain<?php echo $row['id_terrain']; ?>; <?php echo $row['description']; ?> <?php echo $row['img1']; ?> Prix du terrain: <?php echo $row['prix']; ?>  Bonjour, je m'interesse à ce terrain. Je souhaite avoir plus d'information. Merci" class="bi bi-whatsapp btn btn-success"> Whatsapp</a>               
