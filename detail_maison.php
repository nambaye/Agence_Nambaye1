...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
   ...
   <?php
    ...
    $id = $_GET["id"] ;
    $sql = "SELECT * FROM maison WHERE id_maison = ".$id ;
          ...
          <div class="col-md-12 col-lg-4">
            <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <a href="maison.php">Les maisons</a>
                </li>
              </ol>
            </nav>
          </div>
    ...
    <section class="property-single nav-arrow-b">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
             <div class="photo">
              <img src="<?php echo "images/image_maison/".$row['img1']; ?>" alt="" class="img-d img-fluid" >
              </div>
          </div>
        
          <div class="col-lg-6">
             <div class="photo" >
              <img src="<?php echo "images/image_maison/".$row['img2']; ?>" alt="" class="img-d img-fluid" >
                </div>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-lg-6">
             <div class="photo">
              <img src="<?php echo "images/image_maison/".$row['img3']; ?>" alt="" class="img-d img-fluid" >
                </div>
          </div>
          
          <div class="col-lg-6">
             <div class="photo">
              <img src="<?php echo "images/image_maison/".$row['img4']; ?>" alt="" class="img-d img-fluid" >
                </div>
          </div>
        </div>
 <br><br>
            ...
            <div class="row">
              <div class="col-md-6 col-lg-4">
               ...
               <hr>
                ...
                <a href="https://wa.me/+23672281873? text= ID Maison<?php echo $row['id_maison']; ?>; <?php echo $row['description']; ?> <?php echo $row['img1']; ?> Prix maison : <?php echo $row['prix']; ?>  Bonjour, je m'interesse à cette maison. Je souhaite avoir plus d'information. Merci" class="bi bi-whatsapp btn btn-success"> Whatsapp</a>               
              ...
              <div class="col-md-6 col-lg-4">
               ...
               <hr>
                  ...
                  <p class="color-text-a">
                    Contactez notre agent qui s'occupe de la maison. Il repondra à tous vos besoins et sera disponible pour vous faire la visite des lieux selon vos disponibilités.
                  </p>
                  <ul class="list-unstyled">
                    <li class="d-flex justify-content-between">
                      <strong>Numéro agent:</strong>
                      <span class="color-text-a">(+236) 70 55 42 68</span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>WhatSapp uniquement:</strong>
                      <span class="color-text-a">(+236) 72 28 18 73</span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>Email:</strong>
                      <span class="color-text-a">immorca236@gmail.com</span>
                    </li>
                  </ul>
                </div>
              </div>
                  ...
                  <form class="form-a" method="POST">
                    <div class="row">
                      <div class="col-md-12 mb-1">
                        ...
                        <hr>
                        <div class="form-group">
                          <input type="text" class="form-control " name="Nom_msg" placeholder="Nom complet *">
                        </div>
                      </div>
                      <div class="col-md-12 mb-1">
                        <div class="form-group">
                          <input type="tel" class="form-control" name="Tel_message" placeholder="Telephone *">
                        </div>
                      </div>
                      <div class="col-md-12 mb-1">
                        <div class="form-group">
                          <input type="email" class="form-control" name="Email_message" placeholder="Email *">
                        </div>
                      </div>
                      <div class="col-md-12 mb-1">
                        <div class="form-group">
                          <textarea class="form-control" placeholder="Saisissez votre message *" name="Text_message"></textarea>
                        </div>
                      </div>
                      <div class="col-md-12 mt-3">
                        <button name="message" type="submit" class="btn btn-a">Envoyer</button>
                      </div>
                    </div>
                  </form>
                </div>
              ...
              if(isset($_POST['message'])){
                $retour = mail('josuenambayefr@gmail.com', 'Envoyer depuis la page du site IMMO236', $_POST['Text_message'], 'From: josuenambayefr@gmail.com' ."\r\n". 'Reply-to: '.$_POST['Email_message'] );
                if ($retour) {
