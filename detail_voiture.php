            ...
            <div class="row">
              <div class="col-md-6 col-lg-4">
               ...
               <hr>
                ...
                <a href="https://wa.me/+23672281873? text= ID_Voiture<?php echo $row['id_voiture']; ?>; <?php echo $row['numero_chassis']; ?> <?php echo $row['img1']; ?> Prix de la voiture: <?php echo $row['prix']; ?>  Bonjour, je m'interesse à cette voiture. Je souhaite avoir plus d'information. Merci" class="bi bi-whatsapp btn btn-success"> Whatsapp</a>               
